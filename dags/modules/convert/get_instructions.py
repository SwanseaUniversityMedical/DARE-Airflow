...
def get_instructions(datasetname):
            ...
            if hits == 1:  # single answer
                ...
                if attributes:
                    for attribute in attributes:
                        ...
                        attribs[attribute_name] = AttributeSearch(attribute_source, attribute_regex, attribute_single)
                else:
    ...
    return attribs, templates, duckdb_params, process, action, default_used
